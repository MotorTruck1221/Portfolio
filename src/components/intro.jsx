...
function Intro() {
    return (
        <div className='flex items-center justify-center flex-col text-center pt-20 pb-6'>
            ...
            <p className='text-sm max-w-xl mb-6 font-bold'>I'm a 18-year-old full-stack developer with a passion for exploring new technologies. I'm currently working on a few projects such
